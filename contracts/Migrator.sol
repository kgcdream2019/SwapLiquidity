...
contract Migrator {
    ...
    function migrate(IJulSwapHPair orig) public returns (IJulSwapHPair) {
        ...
        if (pair == IJulSwapHPair(address(0))) {
            pair = IJulSwapHPair(factory.createPair(token0, token1));
        }
